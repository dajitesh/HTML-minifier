...
const Sidebar = () => {
  return (
    // <div className="flex flex-col h-full p-3 w-60 dark:bg-gray-50 dark:text-gray-800 mt-16 shadow-2xl">
    //   <div className="space-y-3 ">
    //     <div className="flex-1 mt-6">
    //       <ul className="pt-2 pb-4 space-y-1 text-sm">
    //         <li className="rounded-sm">
    //           <Link rel="noopener noreferrer" href="/docs/getting-started" className="flex items-center p-2 space-x-3 rounded-md">

    //             <span>Introduction</span>
    //           </Link>
    //         </li>
    //         <li className="rounded-sm">
    //           <Link rel="noopener noreferrer" href="/docs/features" className="flex items-center p-2 space-x-3 rounded-md">
